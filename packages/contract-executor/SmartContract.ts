...
import {runContractAssebly, TVMStack, TVMStackEntry} from "./executor";
...
export class SmartContract {
    ...
    async invokeGetMethod(method: string, args: TVMStack) {
        let res = await runContractAssebly(
            this.assemblyCode,
            this.dataCell,
            args,
            method
        ...
        return {
            ...
            data_cell: bocToCell(res.data_cell),
            action_list_cell: bocToCell(res.action_list_cell)
        }
    }
